...
/** Progress checklist for the Gross Margin Analytical Review pipeline. */
...
const STEPS = [
  { index: 0, label: 'Request GM data', detail: 'Revenue, COS, budget, PY breakdowns' },
  { index: 1, label: 'Compute analysis', detail: 'GM% per period, expected vs actual, tolerance check' },
  { index: 2, label: 'Request management explanations', detail: 'For each flagged variance' },
  { index: 3, label: 'AI plausibility assessment', detail: 'Red / Orange / Green per variance' },
  { index: 4, label: 'Team review', detail: 'Sign off findings and conclusions' },
];
