...
const MODEL_REGISTRY: ModelProfile[] = [
  ...
  { id: 'Qwen/Qwen3.5-9B',                                      speed: 4, accuracy: 3, depth: 2, cost: 4, vision: true },
  ...
  { id: 'meta-llama/Llama-3.3-70B-Instruct-Turbo',                                speed: 1, accuracy: 5, depth: 5, cost: 1, vision: true },
];
...
const AI_PRICING: Record<string, { inputPerToken: number; outputPerToken: number }> = {
  ...
  'Qwen/Qwen3.5-9B': { inputPerToken: 0.10 / 1_000_000, outputPerToken: 0.15 / 1_000_000 },
  'meta-llama/Llama-3.3-70B-Instruct-Turbo': { inputPerToken: 0.60 / 1_000_000, outputPerToken: 3.60 / 1_000_000 },
