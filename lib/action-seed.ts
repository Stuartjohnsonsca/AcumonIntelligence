...
export const SYSTEM_ACTIONS: ActionDefinitionData[] = [
...

  {
    ...
    name: 'Reconcile to Trial Balance',
    description: 'Takes a data_table (parsed listing or register) and a set of TB account codes. Sums the listing, compares to the TB total at period end, flags variance, and emits a per-row / per-code unreconciled list.',
    category: 'verification',
    ...
    inputSchema: [
      ...
      { code: 'amount_column', label: 'Amount Column', type: 'text', required: false, source: 'user', group: 'Data', defaultValue: 'amount' },
      { code: 'account_codes', label: 'TB Account Codes', type: 'text', required: true, source: 'user', group: 'Reconciliation', description: 'Comma-separated TB codes whose sum at period end should match the listing total.' },
