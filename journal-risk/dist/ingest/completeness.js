...
exports.computeHashTotals = computeHashTotals;
exports.validateBalancedPopulation = validateBalancedPopulation;
exports.computeCoverageEvidence = computeCoverageEvidence;
exports.buildPopulationEvidence = buildPopulationEvidence;
/**
 ...
 */
function computeHashTotals(journals) {
    let totalDebits = 0;
    let totalCredits = 0;
 ...
 */
function validateBalancedPopulation(journals) {
 ...
 */
function computeCoverageEvidence(journals, config) {
    ...
    for (const j of journals) {
        ...
        if (isNaN(posted.getTime()))
            continue;
        if (earliest === null || posted < earliest)
            earliest = posted;
 ...
 */
function buildPopulationEvidence(journals, config) {
