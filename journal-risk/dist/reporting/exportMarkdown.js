...
exports.exportMarkdownSummary = exportMarkdownSummary;
const fs_1 = __importDefault(require("fs"));
/**
 * Export a human-readable Markdown summary of the journal risk selection run.
 */
function exportMarkdownSummary(runResult, outputPath) {
    ...
    lines.push('');
    lines.push('Selection criteria included post-close/period-end journals, unusual/seldom accounts, ' +
